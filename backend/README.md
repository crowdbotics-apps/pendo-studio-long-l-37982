...
## Project Structure
    ...
    ├── pendo_studio_long_l_37982  # Django project configurations
...
1. Clone this repo and `cd pendo_studio_long_l_37982`
...
2. Clone this repo and `cd pendo_studio_long_l_37982`
